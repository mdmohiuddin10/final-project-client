            ...
            <div className="">
                 ...
                 <div key={data._id} className="flex lg:flex-row flex-col-reverse px-5 pt-10 gap-8 bg-gradient-to-r from-pink-500 to-violet-500">
                        ...
                        <div className="flex-1">
                            ...
                            { data.status === 'premium'? <button type="button" className="text-white bg-orange-400 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 mt-5 "> Premium Member</button> :
